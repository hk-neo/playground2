@REQ_PLAYG-1970
Feature: SR-001 DICOM 파일 로드 및 파싱
	#DICOM 형식의 CBCT 영상 파일을 로컬 스토리지에서 로드하고 파싱하여 내부 데이터 구조로 변환하는 기능. DICOM 태그 파싱, 환자 정보 추출, 영상 데이터 디코딩을 포함.

	#매우 큰 용량의 Pixel Data를 포함한 DICOM 파일을 로드할 때, 메모리 부족 오류 없이 정상적으로 파싱을 완료하거나 정의된 제한 내에서 처리하는지 확인한다.
	@TEST_PLAYG-2529 @REQ_PLAYG-2352 @TESTSET_PLAYG-2476 @AI
	...
	@TEST_PLAYG-2527 @REQ_PLAYG-2352 @REQ_PLAYG-2353 @TESTSET_PLAYG-2476 @AI
	...
	@TEST_PLAYG-2520 @REQ_PLAYG-2352 @REQ_PLAYG-2353 @TESTSET_PLAYG-2476 @AI
	...
	@TEST_PLAYG-2519 @REQ_PLAYG-2352 @REQ_PLAYG-2353 @TESTSET_PLAYG-2476 @AI
	...
	@TEST_PLAYG-2516 @REQ_PLAYG-2352 @TESTSET_PLAYG-2476 @AI
